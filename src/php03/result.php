<?php
require_once("config/functions/search_city_time.php");
$tokyo = searchCityTime("東京");
$city= htmlspecialchars($_GET["city"],ENT_QUOTES);
$specialCity = searchCityTime($city);
...
<body>
    ...
    <div class="result__content">
        <div class="result-cards">
            ...
            <div class="result-card">
                <div class="result-card__img-wrapper">
                    <img class="result-card__img" src="img/<?php echo $specialCity["img"]?>" alt="国旗">
                </div>
                <div class="result-card__body">
                    <p class="result-card__city"><?php echo $specialCity["name"]?></p>
                    <p class="result-card__time"><?php echo $specialCity["time"]?></p>
                </div>
            </div>
        </div>
    </div>
